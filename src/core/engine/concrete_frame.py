...
class ConcreteFrameCalculator:
    ...
    def __init__(self):
        ...
        self.gamma_c = 1.5      # Calcestruzzo
        self.gamma_s = 1.15     # Acciaio armatura
        self.alpha_cc = 0.85    # Coefficiente effetto carichi di lunga durata
        
        # Proprietà materiali
        self.concrete_properties = {
            'C20/25': {'fck': 20, 'fcm': 28, 'fctm': 2.2, 'Ecm': 30000},
            'C25/30': {'fck': 25, 'fcm': 33, 'fctm': 2.6, 'Ecm': 31000},
            'C28/35': {'fck': 28, 'fcm': 36, 'fctm': 2.8, 'Ecm': 32000},
            'C32/40': {'fck': 32, 'fcm': 40, 'fctm': 3.0, 'Ecm': 33000},
            'C35/45': {'fck': 35, 'fcm': 43, 'fctm': 3.2, 'Ecm': 34000}
        }
        
        self.steel_properties = {
            'B450C': {'fyk': 450, 'ftk': 540, 'Es': 200000},
            'B450A': {'fyk': 450, 'ftk': 540, 'Es': 200000}
        }
    ...
    def _calculate_rc_portal_frame_stiffness(self, h: float, L: float, 
        ...
        if 'piedritti' in rinforzo_data:
            ...
            K *= 0.5  # Inerzia fessurata ≈ 0.5 Ig
